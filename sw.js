const CACHE_NAME = 'koala-universe-demo-v30';
const APP_SHELL = ['./', './index.html', './styles.css?v=30', './app.js?v=30', './cloud.js?v=30', './config.js', './manifest.webmanifest', './app-icon.svg', './icon-192.png', './icon-512.png'];
