const CACHE_NAME = 'koala-universe-demo-v43';
const APP_SHELL = ['./', './index.html', './styles.css?v=43', './app.js?v=43', './cloud.js?v=43', './config.js', './manifest.webmanifest', './app-icon.svg', './icon-192.png', './icon-512.png'];
