const CACHE_NAME = 'koala-universe-demo-v38';
const APP_SHELL = ['./', './index.html', './styles.css?v=38', './app.js?v=38', './cloud.js?v=38', './config.js', './manifest.webmanifest', './app-icon.svg', './icon-192.png', './icon-512.png'];
