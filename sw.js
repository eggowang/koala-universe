const CACHE_NAME = 'koala-universe-demo-v40';
const APP_SHELL = ['./', './index.html', './styles.css?v=40', './app.js?v=40', './cloud.js?v=40', './config.js', './manifest.webmanifest', './app-icon.svg', './icon-192.png', './icon-512.png'];
