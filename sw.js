const CACHE_NAME = 'koala-universe-demo-v46';
const APP_SHELL = ['./', './index.html', './styles.css?v=46', './app.js?v=46', './cloud.js?v=46', './config.js', './manifest.webmanifest', './app-icon.svg', './icon-192.png', './icon-512.png'];
