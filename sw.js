const CACHE_NAME = 'koala-universe-demo-v45';
const APP_SHELL = ['./', './index.html', './styles.css?v=45', './app.js?v=45', './cloud.js?v=45', './config.js', './manifest.webmanifest', './app-icon.svg', './icon-192.png', './icon-512.png'];
