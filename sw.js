const CACHE_NAME = 'koala-universe-demo-v44';
const APP_SHELL = ['./', './index.html', './styles.css?v=44', './app.js?v=44', './cloud.js?v=44', './config.js', './manifest.webmanifest', './app-icon.svg', './icon-192.png', './icon-512.png'];
