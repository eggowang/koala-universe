const CACHE_NAME = 'koala-universe-demo-v7';
const APP_SHELL = ['./', './index.html', './styles.css?v=7', './app.js?v=7', './cloud.js?v=7', './config.js', './manifest.webmanifest', './app-icon.svg', './icon-192.png', './icon-512.png'];
