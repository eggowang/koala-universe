const CACHE_NAME = 'koala-universe-demo-v13';
const APP_SHELL = ['./', './index.html', './styles.css?v=13', './app.js?v=13', './cloud.js?v=13', './config.js', './manifest.webmanifest', './app-icon.svg', './icon-192.png', './icon-512.png'];
