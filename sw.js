const CACHE_NAME = 'koala-universe-demo-v18';
const APP_SHELL = ['./', './index.html', './styles.css?v=18', './app.js?v=18', './cloud.js?v=18', './config.js', './manifest.webmanifest', './app-icon.svg', './icon-192.png', './icon-512.png'];
