const CACHE_NAME = 'koala-universe-demo-v28';
const APP_SHELL = ['./', './index.html', './styles.css?v=28', './app.js?v=28', './cloud.js?v=28', './config.js', './manifest.webmanifest', './app-icon.svg', './icon-192.png', './icon-512.png'];
