const CACHE_NAME = 'koala-universe-demo-v25';
const APP_SHELL = ['./', './index.html', './styles.css?v=25', './app.js?v=25', './cloud.js?v=25', './config.js', './manifest.webmanifest', './app-icon.svg', './icon-192.png', './icon-512.png'];
