const CACHE_NAME = 'koala-universe-demo-v12';
const APP_SHELL = ['./', './index.html', './styles.css?v=12', './app.js?v=12', './cloud.js?v=12', './config.js', './manifest.webmanifest', './app-icon.svg', './icon-192.png', './icon-512.png'];
