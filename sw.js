const CACHE_NAME = 'koala-universe-demo-v41';
const APP_SHELL = ['./', './index.html', './styles.css?v=41', './app.js?v=41', './cloud.js?v=41', './config.js', './manifest.webmanifest', './app-icon.svg', './icon-192.png', './icon-512.png'];
