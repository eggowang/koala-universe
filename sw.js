const CACHE_NAME = 'koala-universe-demo-v39';
const APP_SHELL = ['./', './index.html', './styles.css?v=39', './app.js?v=39', './cloud.js?v=39', './config.js', './manifest.webmanifest', './app-icon.svg', './icon-192.png', './icon-512.png'];
