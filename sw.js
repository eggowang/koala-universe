const CACHE_NAME = 'koala-universe-demo-v34';
const APP_SHELL = ['./', './index.html', './styles.css?v=34', './app.js?v=34', './cloud.js?v=34', './config.js', './manifest.webmanifest', './app-icon.svg', './icon-192.png', './icon-512.png'];
