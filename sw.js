const CACHE_NAME = 'koala-universe-demo-v22';
const APP_SHELL = ['./', './index.html', './styles.css?v=22', './app.js?v=22', './cloud.js?v=22', './config.js', './manifest.webmanifest', './app-icon.svg', './icon-192.png', './icon-512.png'];
