const CACHE_NAME = 'koala-universe-demo-v29';
const APP_SHELL = ['./', './index.html', './styles.css?v=29', './app.js?v=29', './cloud.js?v=29', './config.js', './manifest.webmanifest', './app-icon.svg', './icon-192.png', './icon-512.png'];
