const CACHE_NAME = 'koala-universe-demo-v17';
const APP_SHELL = ['./', './index.html', './styles.css?v=17', './app.js?v=17', './cloud.js?v=17', './config.js', './manifest.webmanifest', './app-icon.svg', './icon-192.png', './icon-512.png'];
