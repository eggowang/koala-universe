const CACHE_NAME = 'koala-universe-demo-v27';
const APP_SHELL = ['./', './index.html', './styles.css?v=27', './app.js?v=27', './cloud.js?v=27', './config.js', './manifest.webmanifest', './app-icon.svg', './icon-192.png', './icon-512.png'];
