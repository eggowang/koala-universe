const CACHE_NAME = 'koala-universe-demo-v33';
const APP_SHELL = ['./', './index.html', './styles.css?v=33', './app.js?v=33', './cloud.js?v=33', './config.js', './manifest.webmanifest', './app-icon.svg', './icon-192.png', './icon-512.png'];
