const CACHE_NAME = 'koala-universe-demo-v35';
const APP_SHELL = ['./', './index.html', './styles.css?v=35', './app.js?v=35', './cloud.js?v=35', './config.js', './manifest.webmanifest', './app-icon.svg', './icon-192.png', './icon-512.png'];
