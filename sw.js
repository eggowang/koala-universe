const CACHE_NAME = 'koala-universe-demo-v10';
const APP_SHELL = ['./', './index.html', './styles.css?v=10', './app.js?v=10', './cloud.js?v=10', './config.js', './manifest.webmanifest', './app-icon.svg', './icon-192.png', './icon-512.png'];
