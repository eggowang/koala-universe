const CACHE_NAME = 'koala-universe-demo-v19';
const APP_SHELL = ['./', './index.html', './styles.css?v=19', './app.js?v=19', './cloud.js?v=19', './config.js', './manifest.webmanifest', './app-icon.svg', './icon-192.png', './icon-512.png'];
