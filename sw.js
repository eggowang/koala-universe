const CACHE_NAME = 'koala-universe-demo-v47';
const APP_SHELL = ['./', './index.html', './styles.css?v=47', './app.js?v=47', './cloud.js?v=47', './config.js', './manifest.webmanifest', './app-icon.svg', './icon-192.png', './icon-512.png'];
