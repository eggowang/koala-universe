const CACHE_NAME = 'koala-universe-demo-v32';
const APP_SHELL = ['./', './index.html', './styles.css?v=32', './app.js?v=32', './cloud.js?v=32', './config.js', './manifest.webmanifest', './app-icon.svg', './icon-192.png', './icon-512.png'];
