const CACHE_NAME = 'koala-universe-demo-v24';
const APP_SHELL = ['./', './index.html', './styles.css?v=24', './app.js?v=24', './cloud.js?v=24', './config.js', './manifest.webmanifest', './app-icon.svg', './icon-192.png', './icon-512.png'];
